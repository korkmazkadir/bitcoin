...
knit: (function(inputFile, encoding) { 
      workingDir <- '/home/kadir/Desktop/bitcoin_with_new_simulator_copy';
...
To emulate mining, we have used the mining sımulator we have designed together using the negative binomial distribution. 
